  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <form action="<?php echo base_url(); ?>c_admin/editInstagram/<?php echo "$id" ?>" method="post" enctype="multipart/form-data">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Edit Foto IG</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputFile">Foto IG</label>
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama IG</label>
