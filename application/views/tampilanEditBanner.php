  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <form action="<?php echo base_url(); ?>c_admin/editBanner/<?php echo "$id" ?>" method="post" enctype="multipart/form-data">
          <div class="box">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Banner</label>
                   <input type="text" class="form-control" id="nama" value="<?php echo $namaBanner ?>" name="nama" placeholder="Masukkan nama" > 
                </div>
