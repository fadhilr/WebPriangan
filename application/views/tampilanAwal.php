...
<body>
	...
	<div class="baneer-w3ls">
		...
		<br/>
		<div class="row no-gutters">
			<div class="col-xl-12 col-lg-6 callbacks_container">
				<!-- banner slider -->
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						<div class="carousel-item active">
							<img src="<?php echo base_url();?>/assets/images/Banner1.jpg" class="" alt="User Image" width="100%" height="auto">
			...
			<div class="row footer-top">
				...
				<div class="col-lg-4 footer-grid_section_1its">
					...
					<div class="info-form-right mt-4 p-0">
						<form action="<?php echo base_url(); ?>c_web/requestInfo" method="post">
							<div class="row">
