  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Foto IG</li>
      </ol>
    </section>
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <!-- /.box -->
          <form action="<?php echo base_url(); ?>c_admin/aksi_uploadIg" method="post" enctype="multipart/form-data">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tambah Foto Ig</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="box-body">
