	...
	<section class="w3ls-bnrbtm py-5" id="about">
		<div class="container py-xl-5 py-lg-3">
			<div class="title-section text-center mb-md-5 mb-4">
				<h3 class="w3ls-title mb-3">Pembelian Secara <span>Offline</span></h3>
			</div>
			<div class="row">
				<div class="col-lg-6 pr-xl-5 mt-xl-2 mt-lg-0">
					<h3 class="title-sub mb-4">Online</h3>
					<p class="sub-para">Bagi calon pembeli yang jauh dari lokasi outlet kami ataupun bagi pembeli yang tidak
sempat mengunjungi outlet kami untuk berbelanjan dapat berbelanja secara online</p>
<br>
<p>
<a href="https://api.whatsapp.com/send?phone=628211111111&text=Halo%20Priangan%20Sari"><img src="<?php echo base_url();?>/assets/images/deliveryorder.png" alt="">Delivery Order</a></p>
									<p class="sub-para pt-4 mt-4 border-top"></p>
									<h3 class="title-sub mb-4">Offline</h3>
					<p class="sub-para">Bagi calon pembeli yang ingin berbelanja langsung ke outlet kami demi mendapatkan
pengalaman berbelanja yang berkesan silahkan mengunjungi outlet-outlet kami
dibawah ini dengan mengklik tautan dibawah ini.</p>
				</div>
		...
		<div class="container py-xl-4">
			<div class="row footer-top">
				...
				<div class="col-lg-4 footer-grid_section_1its my-lg-0 my-sm-4 my-4">
					...
					<a href="https://api.whatsapp.com/send?phone=628211111111&text=Halo%20Priangan%20Sari"><img src="<?php echo base_url();?>/assets/images/deliveryorder.png" alt=""></a>
					</div>
